<?php /*a:5:{s:69:"/home/wwwroot/www/lungcare/app/admin/view/order/store_order/index.php";i:1578883024;s:62:"/home/wwwroot/www/lungcare/app/admin/view/public/container.php";i:1567990146;s:63:"/home/wwwroot/www/lungcare/app/admin/view/public/frame_head.php";i:1572938472;s:58:"/home/wwwroot/www/lungcare/app/admin/view/public/style.php";i:1568613772;s:65:"/home/wwwroot/www/lungcare/app/admin/view/public/frame_footer.php";i:1567990146;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="spread_uid">
                        {{# if(d.spread_uid != 0){ }}
                        <button class="btn btn-default btn-xs btn-outline" type="button" onclick="$eb.createModalFrame('推荐人信息','<?php echo Url('order_spread_user'); ?>?uid={{d.spread_uid}}',{w:600,h:400})">{{d.spread_nickname}}</button>
                        {{# }else{ }}无{{# } }}
                    </script>
                    <!--支付状态-->
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button class="btn btn-primary btn-xs" type="button" onclick="$eb.createModalFrame('发送货','<?php echo Url('order_goods'); ?>?id={{d.id}}',{w:400,h:250})">
