<?php /*a:1:{s:65:"/home/wwwroot/www/lungcare/app/admin/view/public/edit_content.php";i:1567990146;}*/ ?>
<!doctype html>
...
<body>
<button class="btn btn-success  dim" data-url="<?php echo htmlentities($action); ?>" type="button"><i class="fa fa-upload"></i>
</button>
<textarea type="text/plain" id="myEditor" style="width:100%;"><?php echo !empty($content) ? htmlentities($content) :  ''; ?></textarea>
<script type="text/javascript">
    $eb = parent._mpApi;
    $('.dim').on('click',function(){
        $eb.axios.post($(this).data('url'),{'<?php echo htmlentities($field); ?>':getContent()}).then(function(res){
